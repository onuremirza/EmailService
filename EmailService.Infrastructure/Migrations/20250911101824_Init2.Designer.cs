...
namespace EmailService.Infrastructure.Migrations
{
    ...
    [Migration("20250911101824_Init2")]
    partial class Init2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EmailService.Domain.Entities.RabbitMqOptions", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("PersistentMessages")
                        .HasColumnType("boolean");
                    ...
                    b.Property<bool>("PublisherConfirms")
                        .HasColumnType("boolean");
                    ...
                    b.ToTable("RabbitMqOptions");
                });

            modelBuilder.Entity("EmailService.Domain.Entities.RabbitMqOptions+RetryOptions", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("EmailService.Domain.Entities.RabbitMqOptions", b =>
                {
                    b.HasOne("EmailService.Domain.Entities.RabbitMqOptions+RetryOptions", "Retry")
                        .WithMany()
                        .HasForeignKey("RetryId")
